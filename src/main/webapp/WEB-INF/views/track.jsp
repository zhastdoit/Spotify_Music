...
<div class="container">
    <div class="col-sm-2">
        <img src="http://image.freepik.com/free-icon/music-album_318-43321.jpg" class="img-circle" height="140" width="140">
    </div>
            ...
            <form class="form-inline" id="rate" method="POST" action="${contextPath}/track/${track.id}">
                <div class="form-group col-xs-6">
                    ...
                    <div class="input-group">
                        <input type="number" id="rateScore" name="rateScore" class="form-control" placeholer="Rate this track">
